...
Sonic_SlopeResist:
		...
		tst.w	d0
		beq.s	locret_13502
loc_13504:	add.w	d0,obInertia(a0) ; change Sonic's inertia
...
; continue straight to Player_JumpFlip (Taken from Sonic 3 & Knuckles. TODO IMPLEMENT
...
.noinvert:
		...
		mvabs.w	obInertia(a0),d2 ; get Sonic's speed
