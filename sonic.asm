...
Tit_LoadText:
		...
		move.w	d0,(v_unused2).w ; unused variable
...
LevSel_Credits:
		...
		clr.w	(v_creditsnum).w	; start at the first credits page
		move.b	#bgm_Credits,d0		; set credits music
		bra.w	QueueSound2		; play it
; ===========================================================================
...
Level_SkipClr:
	...
	;	moveq	#0,d0		; unneccesary, d0 still equals 0
		move.b	(v_zone).w,d0
		lsl.w	#2,d0
		movea.l	(a1,d0.w),a1
