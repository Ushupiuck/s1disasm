...
specialStageData: macro frame,mappings,palette,vram
		...
		specialStageData	1, Map_Ring,      1, ArtTile_Ring ; the following are unused
		specialStageData	1, Map_Ring,      1, ArtTile_Ring
		specialStageData	1, Map_Ring,      1, ArtTile_Ring
		specialStageData	1, Map_Ring,      1, ArtTile_Ring
		specialStageData	1, Map_Ring,      1, ArtTile_Ring
		specialStageData	1, Map_Ring,      1, ArtTile_Ring
		specialStageData	0, Map_Ring,      1, ArtTile_Ring ; Until here.
