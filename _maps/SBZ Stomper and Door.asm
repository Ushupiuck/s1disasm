...
.door:	spriteHeader
	spritePiece	-$40, -$C, 4, 3, $1D4, 0, 0, 1, 0 ; horizontal sliding door (offset from stomper by $25 tiles)
	spritePiece	-$20, -$C, 4, 3, $1D7, 0, 0, 1, 0
	spritePiece	0, -$C, 4, 3, $1D7, 0, 0, 1, 0
	spritePiece	$20, -$C, 4, 3, $1D4, 1, 0, 1, 0
.door_End
